...
function App() {
    ...
    return (
        <div className="container">
            <h1 className='title'>Сократите ссылку!</h1>
            <div>
                <input className='inputLink' id="newLink" type="text" placeholder="Введите ссылку"/>
                {/*<button className='buttonSave' onClick={() => createNewLink()} >Сохранить</button>*/}
                <a href="#" className="buttonSave" onClick={() => createNewLink()} >Сохранить</a>
            </div>
            <div>
                <ul>
                    {links.map(([id, value]) => {
                        ...
                        return (
                            <li>
                                ...
                                <a href="#" className="buttonSave" onClick={() => deleteUrl(id)} >Удалить</a>
